...
def test_conv_forward():
    ...
    print('------------------------------------------------')
    print('Test settings: stride=1, padding=1, dilation=1')
    print('Forward ....')
    gt = np.array(
    ...
    print('------------------------------------------------------')
    print('Test settings: stride=2, padding=1, dilation=1')
    print('Forward ....')
    pred = conv_fn(x, kernel, stride=2, padding=1)
    gt = np.array(
        [[[[8.3785, 11.7325, 8.4380],
           [12.0774, 17.7747, 12.5322],
           [8.4864, 11.9934, 7.8869]],
          [[8.6690, 11.9184, 7.5811],
           [12.3080, 16.9702, 11.1837],
           [8.5955, 10.8509, 6.6918]],
          [[6.1002, 10.8747, 7.4201],
           [8.3700, 14.7733, 10.0027],
           [5.0483, 9.3217, 6.3245]]],
         [[[8.3785, 11.7325, 8.4380],
           [12.0774, 17.7747, 12.5322],
           [8.4864, 11.9934, 7.8869]],
          [[8.6690, 11.9184, 7.5811],
    ...
    loss.backward()
    xgrad = np.array(
        [[[[1.3136, 2.4255, 1.3136, 2.4255, 1.3136],
           [3.5461, 5.4338, 3.5461, 5.4338, 3.5461],
           [1.3136, 2.4255, 1.3136, 2.4255, 1.3136],
           [3.5461, 5.4338, 3.5461, 5.4338, 3.5461],
           [1.3136, 2.4255, 1.3136, 2.4255, 1.3136]],
          [[1.9640, 4.1183, 1.9640, 4.1183, 1.9640],
           [3.4747, 6.0916, 3.4747, 6.0916, 3.4747],
           [1.9640, 4.1183, 1.9640, 4.1183, 1.9640],
           [3.4747, 6.0916, 3.4747, 6.0916, 3.4747],
           [1.9640, 4.1183, 1.9640, 4.1183, 1.9640]],
          [[1.0076, 2.3132, 1.0076, 2.3132, 1.0076],
           [1.6671, 3.8351, 1.6671, 3.8351, 1.6671],
           [1.0076, 2.3132, 1.0076, 2.3132, 1.0076],
           [1.6671, 3.8351, 1.6671, 3.8351, 1.6671],
           [1.0076, 2.3132, 1.0076, 2.3132, 1.0076]],
          [[1.6879, 2.3434, 1.6879, 2.3434, 1.6879],
           [2.2949, 6.0017, 2.2949, 6.0017, 2.2949],
           [1.6879, 2.3434, 1.6879, 2.3434, 1.6879],
           [2.2949, 6.0017, 2.2949, 6.0017, 2.2949],
           [1.6879, 2.3434, 1.6879, 2.3434, 1.6879]]],
         [[[1.3136, 2.4255, 1.3136, 2.4255, 1.3136],
